...
###################### read images ######################
def _read_img_lmdb(env, key, size,img_type=np.uint8):
...
def read_img(env, path, size=None,img_type=np.uint8):
    ...
    if env is None:  # img
        ...
        img = _read_img_lmdb(env, path, size,img_type=img_type)
